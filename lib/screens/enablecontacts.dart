...
class EnableContacts extends StatefulWidget {
  const EnableContacts({super.key, required this.email});

  final String email;

  @override
  State<EnableContacts> createState() => _EnableContactsState();
}
...
class _EnableContactsState extends State<EnableContacts> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Contatti abilitati"),
      ),
      body: Center(
        child: SizedBox(
          width: 700,
                                ...
                                if (userInfo.hasData) {
                                  ...
                                  return Expanded(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      return PermissionComponentContacts(
                                        name: name,
                                        email: email,
